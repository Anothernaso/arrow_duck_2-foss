...
func _ready() -> void:
	...
	score_label.text = "Time Survived: " + AD_FormatUtils.format_time(AD_ScoreManager.last_time_survived)
	highscore_label.text = "Highscore: " + AD_FormatUtils.format_time(AD_ScoreManager.highscore_time_survived)
