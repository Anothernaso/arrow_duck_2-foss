...
func _on_delete_data_button_down() -> void:
	...
	AD_SaverUtils.delete(AD_Constants.PERSISTENT_DIR_PATH, AD_Constants.CURRENT_TIMELINE_FILE_NAME)
	AD_SaverUtils.delete(AD_Constants.PERSISTENT_DIR_PATH, AD_Constants.HIGHSCORE_FILE_NAME)
